...
param_basicos  <- list( objective= "binary",
                        ...
                        lambda_l1= 25.70844514,         #por ahora, lo dejo fijo
                        lambda_l2= 4.566399089,         #por ahora, lo dejo fijo
...
param_ganadores  <- list( "learning_rate"= 0.088634616, 
                          "feature_fraction"= 0.410314643,
                          "min_data_in_leaf"= 241,
                          "num_leaves"= 826,
                          "num_iterations"= 140,
                          "ratio_corte"= 0.038424845
                        )
