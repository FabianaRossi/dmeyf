...
palancas$variablesdrift  <- c("ccajas_transacciones",
                              ...
                              "Master_fultimo_cierre","Visa_Finiciomora",
                              "cforex_buy","Visa_fultimo_cierre")   #aqui van las columnas que se quieren eliminar
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , rank_mrentabilidad:= rank(mrentabilidad,ties.method="average")] 
  dataset[ , rank_mrentabilidad_annual:= rank(mrentabilidad_annual,ties.method="average")] 
  dataset[ , rank_mcomisiones:= rank(mcomisiones,ties.method="average")] 
  dataset[ , rank_mactivos_margen:= rank(mactivos_margen,ties.method="average")] 
  dataset[ , rank_mpasivos_margen:= rank(mpasivos_margen,ties.method="average")] 
  dataset[ , rank_mcuenta_corriente_adicional:= rank(mcuenta_corriente_adicional,ties.method="average")] 
  dataset[ , rank_mcuenta_corriente:= rank(mcuenta_corriente,ties.method="average")] 
  dataset[ , rank_mcaja_ahorro:= rank(mcaja_ahorro,ties.method="average")] 
  dataset[ , rank_mcaja_ahorro_adicional:= rank(mcaja_ahorro_adicional,ties.method="average")] 
  dataset[ , rank_mcaja_ahorro_dolares:= rank(mcaja_ahorro_dolares,ties.method="average")] 
  
  dataset[ , rank_mdescubierto_preacordado:= rank(mdescubierto_preacordado,ties.method="average")] 
  dataset[ , rank_mcuentas_saldo:= rank(mcuentas_saldo,ties.method="average")] 
  dataset[ , rank_mautoservicio:= rank(mautoservicio,ties.method="average")] 
  dataset[ , rank_mtarjeta_visa_consumo:= rank(mtarjeta_visa_consumo,ties.method="average")] 
  dataset[ , rank_mtarjeta_master_consumo:= rank(mtarjeta_master_consumo,ties.method="average")] 
  dataset[ , rank_mprestamos_personales:= rank(mprestamos_personales,ties.method="average")] 
  dataset[ , rank_mprestamos_prendarios:= rank(mprestamos_prendarios,ties.method="average")] 
  dataset[ , rank_mprestamos_hipotecarios:= rank(mprestamos_hipotecarios,ties.method="average")] 
  dataset[ , rank_mplazo_fijo_dolares:= rank(mplazo_fijo_dolares,ties.method="average")] 
  dataset[ , rank_mplazo_fijo_pesos:= rank(mplazo_fijo_pesos,ties.method="average")] 
  
  dataset[ , rank_minversion1_pesos:= rank(minversion1_pesos,ties.method="average")] 
  dataset[ , rank_minversion1_dolares:= rank(minversion1_dolares,ties.method="average")] 
  dataset[ , rank_minversion2:= rank(minversion2,ties.method="average")] 
  dataset[ , rank_mpayroll:= rank(mpayroll,ties.method="average")] 
  dataset[ , rank_mpayroll2:= rank(mpayroll2,ties.method="average")] 
  dataset[ , rank_mcuenta_debitos_automaticos:= rank(mcuenta_debitos_automaticos,ties.method="average")] 
  dataset[ , rank_mttarjeta_visa_debitos_automaticos:= rank(mttarjeta_visa_debitos_automaticos,ties.method="average")] 
  dataset[ , rank_mttarjeta_master_debitos_automaticos:= rank(mttarjeta_master_debitos_automaticos,ties.method="average")] 
  dataset[ , rank_mpagodeservicios:= rank(mpagodeservicios,ties.method="average")] 
  dataset[ , rank_mpagomiscuentas:= rank(mpagomiscuentas,ties.method="average")] 
  
  dataset[ , rank_mcajeros_propios_descuentos:= rank(mcajeros_propios_descuentos,ties.method="average")] 
  dataset[ , rank_mtarjeta_visa_descuentos:= rank(mtarjeta_visa_descuentos,ties.method="average")] 
  dataset[ , rank_mtarjeta_master_descuentos:= rank(mtarjeta_master_descuentos,ties.method="average")] 
  dataset[ , rank_mcomisiones_mantenimiento:= rank(mcomisiones_mantenimiento,ties.method="average")] 
  dataset[ , rank_mcomisiones_otras:= rank(mcomisiones_otras,ties.method="average")] 
  dataset[ , rank_mforex_buy:= rank(mforex_buy,ties.method="average")] 
  dataset[ , rank_mforex_sell:= rank(mforex_sell,ties.method="average")] 
  dataset[ , rank_mtransferencias_recibidas:= rank(mtransferencias_recibidas,ties.method="average")] 
  dataset[ , rank_mtransferencias_emitidas:= rank(mtransferencias_emitidas,ties.method="average")] 
  dataset[ , rank_mextraccion_autoservicio:= rank(mextraccion_autoservicio,ties.method="average")] 
  
  dataset[ , rank_mcheques_depositados:= rank(mcheques_depositados,ties.method="average")] 
  dataset[ , rank_mcheques_emitidos:= rank(mcheques_emitidos,ties.method="average")] 
  dataset[ , rank_mcheques_depositados_rechazados:= rank(mcheques_depositados_rechazados,ties.method="average")] 
  dataset[ , rank_mcheques_emitidos_rechazados:= rank(mcheques_emitidos_rechazados,ties.method="average")] 
  dataset[ , rank_matm:= rank(matm,ties.method="average")] 
  dataset[ , rank_matm_other:= rank(matm_other,ties.method="average")] 
  dataset[ , rank_Master_mfinanciacion_limite:= rank(Master_mfinanciacion_limite,ties.method="average")] 
  dataset[ , rank_Master_msaldototal:= rank(Master_msaldototal,ties.method="average")] 
  dataset[ , rank_Master_msaldopesos:= rank(Master_msaldopesos,ties.method="average")] 
  dataset[ , rank_Master_msaldodolares:= rank(Master_msaldodolares,ties.method="average")]
  
  dataset[ , rank_Master_mconsumospesos:= rank(Master_mconsumospesos,ties.method="average")] 
  dataset[ , rank_Master_mconsumosdolares:= rank(Master_mconsumosdolares,ties.method="average")] 
  dataset[ , rank_Master_mlimitecompra:= rank(Master_mlimitecompra,ties.method="average")] 
  dataset[ , rank_Master_madelantopesos:= rank(Master_madelantopesos,ties.method="average")] 
  dataset[ , rank_Master_madelantodolares:= rank(Master_madelantodolares,ties.method="average")] 
  dataset[ , rank_Master_mpagado:= rank(Master_mpagado,ties.method="average")] 
  dataset[ , rank_Master_mpagospesos:= rank(Master_mpagospesos,ties.method="average")] 
  dataset[ , rank_Master_mpagosdolares:= rank(Master_mpagosdolares,ties.method="average")] 
  dataset[ , rank_Master_mconsumototal:= rank(Master_mconsumototal,ties.method="average")] 
  dataset[ , rank_Master_mpagominimo:= rank(Master_mpagominimo,ties.method="average")] 
  dataset[ , rank_Visa_mfinanciacion_limite:= rank(Visa_mfinanciacion_limite,ties.method="average")] 
  
  dataset[ , rank_Visa_msaldototal:= rank(Visa_msaldototal,ties.method="average")] 
  dataset[ , rank_Visa_msaldopesos:= rank(Visa_msaldopesos,ties.method="average")] 
  dataset[ , rank_Visa_msaldodolares:= rank(Visa_msaldodolares,ties.method="average")] 
  dataset[ , rank_Visa_mconsumospesos:= rank(Visa_mconsumospesos,ties.method="average")] 
  dataset[ , rank_Visa_mconsumosdolares:= rank(Visa_mconsumosdolares,ties.method="average")] 
  dataset[ , rank_Visa_mlimitecompra:= rank(Visa_mlimitecompra,ties.method="average")] 
  dataset[ , rank_Visa_madelantopesos:= rank(Visa_madelantopesos,ties.method="average")] 
  dataset[ , rank_Visa_madelantodolares:= rank(Visa_madelantodolares,ties.method="average")] 
  dataset[ , rank_Visa_mpagado:= rank(Visa_mpagado,ties.method="average")] 
  dataset[ , rank_Visa_mpagospesos:= rank(Visa_mpagospesos,ties.method="average")] 
  
  dataset[ , rank_Visa_mpagosdolares:= rank(Visa_mpagosdolares,ties.method="average")] 
  dataset[ , rank_Visa_mconsumototal:= rank(Visa_mconsumototal,ties.method="average")] 
  dataset[ , rank_Visa_mpagominimo:= rank(Visa_mpagominimo,ties.method="average")] 
  ...
  dataset[ , edad_ahorro:= cliente_edad / mcaja_ahorro ]
  dataset[ , visaa_mant:= mtarjeta_visa_consumo / mcomisiones_mantenimiento ]
  dataset[ , actm_visa:= mactivos_margen / mtarjeta_visa_consumo ]
  dataset[ , cp_proll:= cproductos /mpayroll ]
  dataset[ , mcc_mov:= mcuenta_corriente / ctrx_quarter ]
