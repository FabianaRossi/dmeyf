...
kscript         <- "981_E5047"
karch_dataset   <- "./datasets/dataset_stacking_v001.csv.gz"  #el dataset que voy a utilizar
...
param_basicos  <- list( objective= "binary",
                            ...
                            max_bin= 512,            #por ahora, lo dejo fijo
...
param_ganadores  <- list( "learning_rate"= 0.026480492, 
                          "feature_fraction"= 0.144234216,
                          "min_data_in_leaf"= 7444,
                          "num_leaves"= 616,
                          "lambda_l1"=22.97248736,
                          "lambda_l2"=54.12254946,
                          "num_iterations"= 288,
                          "ratio_corte"= 0.034014545
                        )
