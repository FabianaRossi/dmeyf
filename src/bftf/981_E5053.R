...
kscript         <- "981_E5053"
karch_dataset   <- "./datasets/dataset_epic_v952b.csv.gz"  #el dataset que voy a utilizar
...
kgen_mes_desde   <- 202003  #desde donde voy a entrenar
...
param_basicos  <- list( objective= "binary",
                        ...
                        #un numero muy grande, lo limita early_stopping_rounds
...
param_ganadores  <- list( "learning_rate"= 0.023773773, 
                          "feature_fraction"= 0.44216199,
                          "min_data_in_leaf"= 2524,
                          "num_leaves"= 811,
                          "lambda_l1"=6.828928785,
                          "lambda_l2"=3.078939052,
                          "num_iterations"=1045,
                          "ratio_corte"=0.038449951
