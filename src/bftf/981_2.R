...
param_basicos  <- list( objective= "binary",
                        ...
                        lambda_l1= 25.96545459,         #por ahora, lo dejo fijo
                        lambda_l2= 57.2981114496477,         #por ahora, lo dejo fijo
                        max_bin= 11,            #por ahora, lo dejo fijo
...
param_ganadores  <- list( "learning_rate"= 0.093725226, 
                          "feature_fraction"= 0.293007189,
                          "min_data_in_leaf"= 241,
                          "num_leaves"= 109,
                          "num_iterations"= 282,
                          "ratio_corte"= 0.033202782
                        )
