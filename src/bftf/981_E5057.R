...
kscript         <- "981_E5057"
karch_dataset   <- "./datasets/dataset_epic_v959.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.058491468, 
                          "feature_fraction"= 0.413245009,
                          "min_data_in_leaf"= 1567,
                          "num_leaves"= 193,
                          "lambda_l1"=17.83221833,
                          "lambda_l2"=11.12000303,
                          "num_iterations"=308,
                          "ratio_corte"=0.036751107
