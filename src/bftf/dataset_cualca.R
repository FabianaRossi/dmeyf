...
palancas$variablesdrift  <- c("active_quarter","cliente_vip","internet","cliente_edad",
                              "cliente_antiguedad","mrentabilidad","mrentabilidad_annual",
                              "mactivos_margen","cproductos","tpaquete1","tpaquete3",
                              "tpaquete4","tcuentas","ccuenta_corriente","mcuenta_corriente_adicional",
                              "mcuenta_corriente","mcaja_ahorro_adicional",
                              "ctarjeta_debito","ctarjeta_debito_transacciones",
                              "ctarjeta_master","ctarjeta_master_transacciones",
                              "mtarjeta_master_consumo",
                              "mplazo_fijo_pesos","cinversion1","minversion1_pesos","minversion1_dolares",
                              "cinversion2","minversion2","cseguro_vida","cseguro_auto","cseguro_vivienda",
                              "cseguro_accidentes_personales","ccaja_seguridad","ccuenta_debitos_automaticos",
                              ...
                              "thomebanking","ccajas_transacciones","ccajas_consultas",
                              "ccajas_depositos","ccajas_extracciones","ccajas_otras","catm_trx",
                              "matm","catm_trx_other","matm_other","tmobile_app","cmobile_app_trx",
                              "Master_delinquency","Master_status","Master_mfinanciacion_limite",
                              ...
                              "Visa_madelantopesos","Visa_madelantodolares","Visa_fultimo_cierre",
