...
param_ganadores  <- list( "learning_rate"= 0.062947668, 
                          "feature_fraction"= 0.904108698,
                          "min_data_in_leaf"= 4188,
                          "num_leaves"= 984,
                          "lambda_l1"=5.930621087,
                          "lambda_l2"=62.68946518,
                          "num_iterations"=195,
                          "ratio_corte"=0.036081611
