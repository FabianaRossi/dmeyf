...
kscript         <- "981_E5043"
karch_dataset   <- "./datasets/dataset_epic_vcualca.csv.gz"  #el dataset que voy a utilizar
...
param_basicos  <- list( objective= "binary",
                        ...
                        max_depth=  -1,   
                        seed= 999983,# -1 significa no limitar,  por ahora lo dejo fijo
...
param_ganadores  <- list( "learning_rate"= 0.085066839, 
                          "feature_fraction"= 0.908858655,
                          "min_data_in_leaf"= 6882,
                          "num_leaves"= 610,
                          "num_iterations"= 304,
                          "ratio_corte"= 0.0461216724,
                          "lambda_l1"	= 8.326375384,
                          
                        "lambda_l2"=29.10950945
                        )
