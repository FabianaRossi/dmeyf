...
karch_dataset  <- "./datasets/dataset_epic_v966.csv.gz"
ksalida  <- "1430_R" 
...
x  <- list()
x$gleaf_size   <-  65.5228126
x$gnum_leaves  <-  0.288568214
x$learning_rate <-  0.181843801
x$feature_fraction <-  0.644964666
x$num_iterations  <- 123
