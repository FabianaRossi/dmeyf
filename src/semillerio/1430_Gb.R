...
x  <- list()
x$gleaf_size   <-  51.28381586
x$gnum_leaves  <-0.384524308
x$learning_rate <-  0.02010666
x$feature_fraction <-0.912927466
x$num_iterations  <- 1073
