...
karch_dataset  <- "./datasets/dataset_epic_v962.csv.gz"
ksalida  <- "1430J_2_E5099" 
...
x  <- list()
x$gleaf_size   <-  45.45069277
x$gnum_leaves  <-  0.472306594
x$learning_rate <-  0.036480781
x$feature_fraction <-0.627639465
x$num_iterations  <- 547
...
dataset  <- dataset[ foto_mes >= 202003 ]
gc()
...
dataset[  foto_mes>=202003 & foto_mes<=202011, generacion := 1L ]
