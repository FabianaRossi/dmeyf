...
karch_dataset  <- "./datasets/dataset_epic_v952_3.csv.gz"
ksalida  <- "1430I_2_E5096" 
...
x  <- list()
x$gleaf_size   <-  54.99858123
x$gnum_leaves  <-  0.556215394
x$learning_rate <-  0.131830387
x$feature_fraction <-0.550591441
x$num_iterations  <- 71
