...
ksalida  <- "semillerio_1430F_E5087" 
...
x  <- list()
x$gleaf_size   <-  64.24906126
x$gnum_leaves  <-  0.088057214
x$learning_rate <-  0.117387294
x$feature_fraction <-  0.427930885
x$num_iterations  <- 289
