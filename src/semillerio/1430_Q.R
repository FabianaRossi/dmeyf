...
karch_dataset  <- "./datasets/dataset_epic_v965.csv.gz"
ksalida  <- "1430_Q" 
...
x  <- list()
x$gleaf_size   <-  69.43589785
x$gnum_leaves  <-  0.955571888
x$learning_rate <-  0.033465862
x$feature_fraction <-  0.687713697
x$num_iterations  <- 211
