...
ksalida  <- "semillerio_1430G_E5092" 
...
x  <- list()
x$gleaf_size   <-  50.42088418
x$gnum_leaves  <-  0.08296953
x$learning_rate <-  0.135797963
x$feature_fraction <-0.403385177
x$num_iterations  <- 439
